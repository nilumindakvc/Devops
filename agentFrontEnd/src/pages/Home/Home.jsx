        ...
        <>
          <div className="site_describe_container_pic  ">
            ...
            <div className="hero_section_para fs-5">
              <p className="display-5 text-warning fw-lighter">
                Looking for overseas job opportunities or niluminda{" "}
              ...
              <p className="fw-lighter">
                ...
                across key global destinations. Whether you're searching for
                better opportunities, checking an agency’s credibility, or
                exploring what's possible abroad, we're here to make sure you
                take every step with confidence and clarity. Join a growing
                community that believes in safe migration, informed choices, and
                honest guidance.
              </p>
            </div>
          </div>
          ...
          <div className="main_section_para fs-5 bg-success-subtle text-success">
            ...
            <p className="fw-lighter">
              ...
              services, we're here to make your international journey smooth,
              safe, and rewarding."
            </p>
          </div>
          ...
          <div className="main_section_para fs-5 bg-secondary-subtle text-dark">
            ...
            <p className="fw-lighter">
              Discover global career opportunities that match your skills,
              dreams, and ambitions. Whether you're seeking to work abroad, grow
              professionally, or connect with top international employers, we
              provide the guidance and trusted connections to make it happen.
              Step into a future without borders—confidently and securely.
            </p>
          </div>
          ...
          <div className="main_section">
            <div className="text_left">
              ...
              <button
                type="button"
                class="btn btn-primary btn-lg"
                onClick={() => navigate("/AgencyRegistering")}
              >
                Get Register Now
              </button>
            </div>
          ...
          <div className="main_section_para fs-5 bg-info-subtle text-primary-emphasis">
            ...
            <p className="fw-lighter">
              ...
              across key global destinations. Whether you're searching for
              better opportunities, checking an agency’s credibility, or
              exploring what's possible abroad, we're here to make sure you take
